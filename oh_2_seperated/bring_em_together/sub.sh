#!/bin/bash
#SBATCH --job-name=scan  		# Job name (testBowtie2)
...
#SBATCH --output=out.out		# Standard output log, e.g., testBowtie2_12345.out
#SBATCH --error=err.err		# Standard error log, e.g., testBowtie2_12345.err
