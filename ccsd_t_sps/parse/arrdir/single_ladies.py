...
#psi4.core.be_quiet()
psi4.set_options({'reference': 'uhf','basis':'aug-cc-pvdz','maxiter':500, 'scf_type': 'pk', 'e_convergence':9,'basis_guess':'cc-pvdz','soscf':True,'soscf_max_iter':25})
psi4.set_module_options('ccenergy',{'maxiter':100})
e = psi4.energy('ccsd(t)')

with open('energy.txt','w') as fn:
	fn.write(f'{e}')
