#!/bin/bash
#SBATCH --job-name=test		# Job name (testBowtie2)
...
#SBATCH --time=0-01:00:00              	# Time limit hrs:min:sec or days-hours:minutes:seconds
...
python batches.py $SLURM_ARRAY_TASK_ID
conda deactivate
